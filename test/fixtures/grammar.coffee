# The mammouth parser is generated by [Jison](http://github.com/zaach/jison)
...
grammar =
  ...
  # mammouth is the **Expression** -- everything that can be an expression
  ...
  # mammouth has two different symbols for functions. `->` is for ordinary
  ...
  # In mammouth, an object literal is simply a list of assignments.
  Object: [
  ...
  Operation: [
    ...
    # [The existential operator](http://jashkenas.github.com/mammouth/#existence).
